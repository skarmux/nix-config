...
Singleton {
    ...
    component Transparency: QtObject {
        ...
        readonly property real base: 0.2
        readonly property real layers: 0.58 // TODO: Not sure what is meant with layers
    }

    component M3Palette: QtObject {
        property color m3primary_paletteKeyColor: "#2AC3DE" // base0
        ...
        property color m3background: "#2F3549" // tokyo-night-dark
        property color m3onBackground: "#CBCCD1" // tokyo-night-dark base06
        ...
        property color m3onSurface: "#CBCCD1" // base06
        ...
        property color m3primary: "#ffffff" // "window title"
        ...
        property color m3tertiary: "#2AC3DE" // base0D "taskbar calendar", "system icon"
        property color m3onTertiary: "#482536"
        property color m3tertiaryContainer: "#B38397"
        property color m3onTertiaryContainer: "#000000"

        property color m3error: "#2AC3DE" // base0D "power menu button"
